...
<body>
    ...
    <!-- Start Top Entry
    ============================================= -->
    <div id="features" class="top-entry-area text-center">
        <div class="container">
            <div class="row">
                <div class="item-box">
                    <!-- Single Item -->
    ...
    <!-- Start Department 
    ============================================= -->
    <div id="departments" class="departments-area bg-gray default-padding bottom-less">
        <div class="container">
            <div class="row">
    ...
    <!-- Start Doctors 
    ============================================= -->
    <div id="doctors" class="doctor-area carousel-shadow default-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="site-heading text-center">

        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 sticky-sidebar">
                    ...
                    <!-- item -->
                    <div class="item">
                        <a class="nile-gallery-item layout-1" href="http://placehold.it/600x450" data-toggle="lightbox" data-gallery="example-gallery"><img src="http://placehold.it/600x450" alt=""></a>
                    </div>
                    <!--// item -->

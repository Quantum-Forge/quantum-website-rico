        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 single-services">
                    <div class="thum">
                        <img class="box-shadow" src="https://placehold.co/1200x720" alt="">
                    </div>
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-md-6 margin-bottom-40px">
                                <ul class="list-style-7 padding-0px">
                                    <li>Built Based on Bootstrap v4.x</li>
                                    <li>Fully Responsive and Retina Ready</li>
                                    <li>Awesome and Modern Design</li>
                    ...
                    <div class="services-sidebar">
                        <div class="block">
                            ...
                            <ul class="services-menu">
                                <li><a href="#">Branded eCommerce</a></li>
                                <li><a href="#">Websites & Digital Platforms</a></li>
                                <li><a href="#">Mobile Development</a></li>
                                <li><a href="#">Brand Strategy & Identity</a></li>
                                <li><a href="#">Video Production & Photography</a></li>
                                <li><a href="#">seo & marketing</a></li>
                            </ul>

                            <div class="title">Our Brochures</div>

                            <ul class="brochures-menu">
                                <li><a class="pdf" href="#"><i class="fa  fa-file-pdf-o"></i> Download PDF</a></li>
                                <li><a class="word" href="#"><i class="fa fa-file-word-o"></i> Download Word</a></li>
                            </ul>
                            ...
                            <div class="contact-info-block call-us">
                                <div class="contact-info opacity-7 clearfix">
                                    ...
                                    <div class="text">
                                        Location : <br> 1105 Saudi Arabia - Street, CA </div>
                                </div>
                                <div class="contact-info ba-1 opacity-7 clearfix">
                                    <div class="icon"><span class="icon_mail_alt"></span></div>
                                    <div class="text">
                                        Email : <br> info@example.com </div>
                                </div>
                                <div class="contact-info opacity-7 clearfix">
                                    <div class="icon"><span class="icon_phone"></span></div>
                                    <div class="text">
                                        Call Us : <br> 00222123333019 </div>
                                </div>
                            </div>
                        </div>
                    </div>

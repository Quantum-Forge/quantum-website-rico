...
<body>
    ...
    <header id="home">
        ...
        <!-- Start Navigation -->
        <nav class="navbar navbar-default bg-dark attr-border navbar-sticky bootsnav">
    ...
    <div class="banner-area heading-exchange text-dark">
        <!-- Side Bg -->
        <div class="side-bg">
            <img src="assets/img/shape.png" alt="Thumb">
        </div>
        <!-- End Side Bg -->
        <div id="bootcarousel" class="carousel double-content inc-top-heading slide carousel-fade animate_text" data-ride="carousel">
            <!-- Wrapper for slides -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="content">
                                            ...
                                            <h3 data-animation="animated fadeInDown">Your health is our priority</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="content">
                                            ...
                                            <h3 data-animation="animated fadeInDown">Affordable solution by better technology</h3>
                                            <p data-animation="animated slideInUp">
                                                The ourselves suffering the sincerity. Inhabit her manners adapted age certain. Debating offended at branched striking be subjects.
                                            </p>
                                            <a data-animation="animated slideInUp" class="btn btn-theme border btn-md" href="#">View Details</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="content">
                                            ...
                                            <h3 data-animation="animated fadeInDown">The country's best heart specialist</h3>
                                            <p data-animation="animated slideInUp">
                                                The ourselves suffering the sincerity. Inhabit her manners adapted age certain. Debating offended at branched striking be subjects.
                                            </p>
                                            <a data-animation="animated slideInUp" class="btn btn-theme border btn-md" href="#">View Details</a>
    ...
    <!-- Start Video BG 
    ============================================= -->
    <div class="video-bg-area text-center shadow dark text-light video-bg-live bg-fixed" style="background-image: url(assets/img/2440x1578.png);">

...
<body>
                ...
                <div class="position-relative">
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-9 col-md-12 position-inherit">
                            ...
                            <ul id="menu-main" class="nav-menu float-xl-right text-lg-center link-padding-tb-15px dropdown-light">
    ...
    <div class="padding-tb-100px">
        <div class="container">
            ...
            <div class="fizo-blog-slider owl-carousel owl-theme">

                <!-- item -->
                <div class="fizo-blog layout-3">
                    <div class="img_in">
                        <img src="http://placehold.it/500x650" alt="">
                    </div>
                    <div class="out">
                        <ul class="meta">
                        ...
                        <a href="#" class="title">How to Market Your Consulting Business For Free</a>
                    </div>
                </div>
                <!-- END item -->
                ...
                <div class="fizo-blog layout-3">
                    ...
                    <div class="out">
                        ...
                        <a href="#" class="title">How to Choose an IT Consulting Firm</a>
                    </div>
                </div>
                <!-- END item -->
                ...
                <div class="fizo-blog layout-3">
                    ...
                    <div class="out">
                        ...
                        <a href="#" class="title">How Anyone Can Start a Consulting Business Today</a>
                    </div>
                </div>
                <!-- END item -->
                ...
                <div class="fizo-blog layout-3">
                    ...
                    <div class="out">
                        ...
                        <a href="#" class="title">Telemarketing is the Best in IT Consulting</a>
                    </div>
                </div>
                <!-- END item -->
    ...
    <div class="container padding-bottom-100px">
        <div class="row masonry-container">
            ...
            <!-- item -->
            <div class="col-xl-3 xol-lg-4 col-md-6 item">
                <div class="fizo-blog layout-4">
                    <div class="img-in">
                        <a href="#"><img src="http://placehold.it/500x650" alt=""></a>
                    </div>
                    <div class="out">
                        <a href="#" class="title">How to Market Your Consulting Business For Free</a>
                        <ul class="meta">
            ...
            <div class="col-xl-3 xol-lg-4 col-md-6 item">
                <div class="fizo-blog layout-4">
                    <div class="img-in">
                        <a href="#"><img src="http://placehold.it/500x450" alt=""></a>
                    </div>
                    <div class="out">
                        <a href="#" class="title">How to Choose an IT Consulting Firm</a>
                        <ul class="meta">
            ...
            <div class="col-xl-3 xol-lg-4 col-md-6 item">
                <div class="fizo-blog layout-4">
                    ...
                    <div class="out">
                        <a href="#" class="title">How Social Media Consulting Will Help You</a>
                        <ul class="meta">
                            <li class="author"><strong>By : <a href="#">Rabie Elkheir </a></strong> </li>
                            <li><strong><a href="#">5 Comments</a></strong></li>
                        </ul>
            ...
            <div class="col-xl-3 xol-lg-4 col-md-6 item">
                <div class="fizo-blog layout-4">
                    ...
                    <div class="out">
                        <a href="#" class="title">Microsoft Business Solutions Partner – new consulting era</a>
                        <ul class="meta">
                            <li class="author"><strong>By : <a href="#">Rabie Elkheir </a></strong> </li>
                            <li><strong><a href="#">5 Comments</a></strong></li>
                        </ul>
            ...
            <div class="col-xl-3 xol-lg-4 col-md-6 item">
                <div class="fizo-blog layout-4">
                    ...
                    <div class="out">
                        <a href="#" class="title">Reasons To Hire Internet Consulting Services</a>
                        <ul class="meta">
                            <li class="author"><strong>By : <a href="#">Rabie Elkheir </a></strong> </li>
                            <li><strong><a href="#">5 Comments</a></strong></li>
                        </ul>
            ...
            <div class="col-xl-3 xol-lg-4 col-md-6 item">
                <div class="fizo-blog layout-4">
                    ...
                    <div class="out">
                        <a href="#" class="title">How to Choose The Right Salesforce Consulting Partners</a>
                        <ul class="meta">
                            <li class="author"><strong>By : <a href="#">Rabie Elkheir </a></strong> </li>
                            <li><strong><a href="#">5 Comments</a></strong></li>
                        </ul>
            ...
            <div class="col-xl-3 xol-lg-4 col-md-6 item">
                <div class="fizo-blog layout-4">
                    ...
                    <div class="out">
                        <a href="#" class="title">Four Benefits Of A Business Consulting Franchise</a>
                        <ul class="meta">
                            <li class="author"><strong>By : <a href="#">Rabie Elkheir </a></strong> </li>
                            <li><strong><a href="#">5 Comments</a></strong></li>
                        </ul>
            ...
            <div class="col-xl-3 xol-lg-4 col-md-6 item">
                <div class="fizo-blog layout-4">
                    ...
                    <div class="out">
                        <a href="#" class="title">Email Marketing Consulting: Boost your Online Business!</a>
                        <ul class="meta">
                            <li class="author"><strong>By : <a href="#">Rabie Elkheir </a></strong> </li>
                            <li><strong><a href="#">5 Comments</a></strong></li>
                        </ul>
            ...
            <div class="col-xl-3 xol-lg-4 col-md-6 item">
                <div class="fizo-blog layout-4">
                    ...
                    <div class="out">
                        <a href="#" class="title">SAP Business One Technical versus Functional Consulting</a>
                        <ul class="meta">
                            <li class="author"><strong>By : <a href="#">Rabie Elkheir </a></strong> </li>
                            <li><strong><a href="#">5 Comments</a></strong></li>
                        </ul>
        ...
        <div class="text-center">
            <ul class="pagination justify-content-center pagination-md pagination-style-1 color">
